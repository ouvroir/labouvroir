...
# Discussion sur le Financement FCI

Edna Brustein, Daniel Frachon

Contente de pouvoir parler de l’aspect poste octroi de cette bête que va travailler ensemble. Courriel envoyé par Emmanuel pertinent pour voir ce qu’il s’en vient. Important de bien connaître les règles de bases en amont, rend les choses beaucoup plus faciles des deux côtés.

Présentation

Daniel Frachon assiste Anne et Edna pour les FCI sur les aspects financiers et administratifs des subvention.

Edna, conseillère à la recherche (bureau de la recherche), fonds des leader FCI: contexte de mise en place d’infrastructure octroyé.

Gestion pré-octroi qui a été exceptionnelle dans sa finalisation avec la réclamation.

Agente de liaison avec le FCI (Edna). Toujours passer par elle et Daniel, ne jamais entrer en contact direct avec le FCI.

Il s’agit aussi de faire la liaison avec les autres intervenants pour faciliter les relations avec les autres acteurs dans l’Université.
...
- gérer les changements, les délais de réalisation et les budgets (demande de modification et prolongation)
    ...
    - échéancier de 3 ans
    - 16 groupes (p14 de la demande) = items qui doivent apparaître dans la demande finale. Synchro: chaque dépense doit être liée au bon item
...
<!-- vérifier pour ordinateur Lena :) oui. C'est un peu compliqué parce que c'est mon père qui l'a acheté, avec un rabais parce qu'il l'a déclaré dans son "entreprise" comme travailleur autonome-->
